...
% UPDATE ON 4/1/2021 FOR TIME-DEPENDENT REACTION RATE CONSTANT

function G_transient = Sweby_tdk(G_00, w, dx, domain, G_0, k_array)
...
% for x < horizon, k = k
% for x > horizonm k = 0
G_transient = G_m(:,n_t) .* exp (-k_array.*t(j));
